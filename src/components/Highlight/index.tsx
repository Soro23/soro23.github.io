...
const Highlight: React.FC<Props> = props => {
  ...
  return (
    <React.Fragment>
      <div
        className={'mt-4 w-full flex flex-col min-h-[50px] items-center p-[16px] border border-solid border-borderColorHover dark:border-borderColorLight rounded-[6px] h-auto'}
      >
        ...
        <div className="w-full flex flex-col justify-between h-full">
          <h2 className="w-full flex items-start m-0 font-sans font-medium">
            ...
            {props.toggle &&
              ...
              >
                <span className={'mr-[5px] text-buttonBackgroundHover dark:text-borderColorHover rotate-[90deg]'}>
          ...
          <div
            className={'w-full flex-col justify-between h-full hidden'}>
            ...
            {props?.functions &&
              <ul className="highlight-desc flex flex-wrap flex-col w-full text-buttonBackgroundHover dark:text-borderColorHover font-sans text-sm px-[30px]" style={{ listStyleType: "disc" }}>
